		...
		if(LANG_CHARSET == "UTF-8"){
	        ...
	        if(is_array($data)){
	            return array_map(function($value){
	                return \Bitrix\Main\Text\Encoding::convertEncoding($value, "windows-1251", LANG_CHARSET);
	            }, $data);
	        }

	        //string
	        else{
	            return !defined("BX_UTF") ? \Bitrix\Main\Text\Encoding::convertEncoding($data, "windows-1251", LANG_CHARSET) : $data;
	        }
