		...
		<tbody>
			<tr>
				<td>
						...
						<tbody>
							...
							<?$countPos +=$arValues["QUANTITY"] ?>
								<tr>
									...
									<td>
										<span class="price">		      
											<?=($arValues["INFO"]["OLD_PRICE"] != $arValues["PRICE"] ? '<s>'.str_replace(GetMessage("RUB"),'<span class="rouble">P<i>-</i></span>', FormatCurrency($arValues["INFO"]["OLD_PRICE"],$arResult["CURRENCY"])).'</s>' : '')?>
				      						<?=str_replace(GetMessage("RUB"),'<span class="rouble">P<i>-</i></span>', FormatCurrency($arValues["PRICE"], $arResult["CURRENCY"]));?>
				      				...
				      				<td>
				      					<span class="sum" data-price="<?=$arValues["PRICE"]?>"><?=str_replace(GetMessage("RUB"),'<span class="rouble">P<i>-</i></span>', FormatCurrency($arValues["PRICE"] * round($arValues["QUANTITY"]), $arResult["CURRENCY"]));?> </span>
				      				</td>
					...
					<div class="orderLine">
						<div id="sum">
							<?=GetMessage("TOTAL_QTY")?> <span class="price" id="countItems"><?=$countPos?></span> <span class="label"><?=GetMessage("TOTAL_SUM")?></span> <span class="price"><span id="allSum"><?=str_replace(GetMessage("RUB"),'<span class="rouble">P<i>-</i></span>', FormatCurrency($arResult["SUM"], $arResult["CURRENCY"]));?></span></span>								
						</div>
					</div>
					<div id="order">
						...
						<div class="orderLine">
							<div id="sum">
								...
								<span class="label"><?=GetMessage("ORDER_DELIVERY")?>:</span>
								<span class="price"><span id="allDevilerySum"><?=str_replace(GetMessage("RUB"),'<span class="rouble">P<i>-</i></span>', FormatCurrency($arResult["SUM_DELIVERY"], $arResult["CURRENCY"]));?></span></span> 
								<span class="label"><?=GetMessage("TOTAL_SUM")?></span> 
								<span class="price"><span id="allOrderSum"><?=str_replace(GetMessage("RUB"),'<span class="rouble">P<i>-</i></span>', FormatCurrency($arResult["SUM"] + $arResult["SUM_DELIVERY"], $arResult["CURRENCY"]));?></span></span>
							</div>
							<div>
