	...
	<div id="personalCart" class="DwBasket">
		<div id="basketTopLine">
			<div id="tabsControl">
				...
				<div class="item"><a href="<?=SITE_DIR?>sigarety/"><?=Loc::getMessage("BASKET_TABS_CONTINUE")?></a></div>
			...
			<div class="minimumPaymentRight">
				<div class="paymentButtons">
					...
					<div class="paymentButtonsCatalog">
						<a href="<?=SITE_DIR?>sigarety/" class="btn-simple btn-small"><?=Loc::getMessage("MINIMUM_PAYMENT_CATALOG_BUTTON")?></a>
					</div>
				</div>
			</div>
		</div>
