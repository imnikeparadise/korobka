		...
		<div class="container" id="fastBuyOpenContainer">
			...
			<div class="column">
				...
				<form action="<?=SITE_DIR?>callback/" id="fastBuyForm" method="GET">
					...
					<div class="formLine" style="display: none;"><input type="checkbox" checked="checked" name="personalInfoFastBuy" id="personalInfoFastBuy"><label for="personalInfoFastBuy">Я согласен на <a href="/personal-info/" class="pilink">обработку персональных данных.</a>*</label></div>
